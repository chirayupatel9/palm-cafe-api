...
const generatePDF = async (invoice) => {
  ...
  return new Promise((resolve) => {
    ...
    try {
      ...
      // Fallback to drawn logo with cafe initial
    ...
    doc.fontSize(20).font('Helvetica-Bold').fill('#153059').text(cafeName.toUpperCase(), margin + 380, 25, { width: 200 }); // Bold font on right side
    ...
    doc.fontSize(9).font('Helvetica-Bold').fill('#ffffff').text(`Thank you for visiting ${cafeName}!`, 0, footerY + 20, { align: 'center', width: pageWidth }); // Better positioned and larger font
